...
W trakcie realizacji projektu korzystaliśmy z narzędzia Claude Code (Anthropic) jako asystenta. Pełna historia promptów dostępna jest w pliku `docs/historia_promptow.md`. Poniżej uczciwa ocena zakresu wykorzystania.
